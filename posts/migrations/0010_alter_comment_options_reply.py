# Generated by Django 5.2.5 on 2025-10-26 20:35
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('posts', '0009_rename_vody_comment_body'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='posts.post')),
            ],
            options={
                'ordering': ['created'],
            },
